...
NAVER_CLIENT_ID = "H0eVNK_mnFjmNsi0iAyc"
NAVER_CLIENT_SECRET = "ZC_2Q5VbQ4"
...
default_queries_map = {
    ...
    "블로그": "요즘 키링 말고도 뭘 달고 다니지?",
    "뉴스": "최근 인기 있는 키링은은 무엇인가요?"
}
...
# 검색 입력 필드 도움말 텍스트
help_texts = {
    "쇼핑": "키링 추천 질문을 클릭하거나 직접 검색어를 입력하세요.",
    "블로그": "블로그 관련 검색어를 입력하세요. (예: 인기 키링)",
    "뉴스": "뉴스 관련 검색어를 입력하세요. (예: 최신 키링 디자인)"
}
...
if active_source_type == "쇼핑":
    st.markdown("👇 **키링링 관련 추천 질문을 선택해보세요!**")
